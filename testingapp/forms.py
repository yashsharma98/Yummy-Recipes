...
class FileModelForm(ModelForm):
    ...
    def save(self,request):
        ...
        post.objects.create(title=title,content=content,ingredients=ingredients,image=image,timing=timing,servings=servings,type=type,cuisine=cuisine,category=category,difficulty=difficulty,author=request.user)
